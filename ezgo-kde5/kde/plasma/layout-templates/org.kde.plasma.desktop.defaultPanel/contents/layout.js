...
panel.length = panelScreen.width
...
firefox.writeConfig("url", "file:///usr/share/ezgo/ezgo-menu/applications/firefox.desktop")

systemsettings =  panel.addWidget("org.kde.plasma.icon")
systemsettings.currentConfigGroup = ["General"]
systemsettings.writeConfig("url", "file:///usr/share/ezgo/ezgo-menu/applications/systemsettings.desktop")

dolphin = panel.addWidget("org.kde.plasma.icon")
dolphin.currentConfigGroup = ["General"]
dolphin.writeConfig("url", "file:///usr/share/ezgo/ezgo-menu/applications/org.kde.dolphin.desktop")
